...
//        correctSchedule1.addTask(b1, p1, correctSchedule1.getEarliestSchedulableTime(b1, p1));
//
//        Schedule correctSchedule2 = new Schedule(processors, graph);
//        Processor p2 = correctSchedule2.getProcessors().get(0);
//        correctSchedule2.addTask(a1, p2, correctSchedule2.getEarliestSchedulableTime(a1, p2));
//        correctSchedule2.addTask(b1, p2, correctSchedule2.getEarliestSchedulableTime(b1, p2));
//
//        Schedule correctSchedule3 = new Schedule(processors, graph);
//        Processor p3 = correctSchedule3.getProcessors().get(0);
//        correctSchedule3.addTask(a1, p3, correctSchedule3.getEarliestSchedulableTime(a1, p3));
//        correctSchedule3.addTask(g1, p3, correctSchedule3.getEarliestSchedulableTime(g1, p3));
//
//        Schedule correctSchedule4 = new Schedule(processors, graph);
//        Processor p41 = correctSchedule4.getProcessors().get(0);
//        Processor p42 = correctSchedule4.getProcessors().get(1);
//        correctSchedule4.addTask(a1, p41, correctSchedule4.getEarliestSchedulableTime(a1, p41));
//        correctSchedule4.addTask(g1, p42, correctSchedule4.getEarliestSchedulableTime(g1, p42));
//
//
//        Schedule correctSchedule5 = new Schedule(processors, graph);
//        Processor p5 = correctSchedule5.getProcessors().get(0);
//        correctSchedule5.addTask(b1, p5, correctSchedule5.getEarliestSchedulableTime(b1, p5));
//
//        Schedule correctSchedule6 = new Schedule(processors, graph);
//        Processor p6 = correctSchedule6.getProcessors().get(1);
//        correctSchedule6.addTask(g1, p6, correctSchedule6.getEarliestSchedulableTime(g1, p6));
//
